...
make install          # pip install -e ".[dbt,dev]"
...
# full pipeline on real data (Kaggle download ~1 GB):
pip install -e ".[ingest,embeddings]"
...
_No metrics recorded yet — run `make train`._
